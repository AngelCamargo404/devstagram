...
@section('contenido')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        <div class="md:w-6/12 p-5">
            <img src="{{ asset('img/registrar.jpg') }}" alt="Registro de Usuario IMG">
        </div>
        ...
        <div class="md:w-4/12 bg-slate-100 p-6 rounded-lg shadow-xl">
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input id="password_confirmation" name="password_confirmation" type="password" placeholder="Password de Registro" class="border p-3 w-full rounded-lg">
